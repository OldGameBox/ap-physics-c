#u1 #vectors
- (*def.*) a physical **quantity** possessing both [[magnitude]] *(size or length)* and **direction**, represented graphically as an arrow.
- Unlike [[scalar|scalar quantities]] that only have [[magnitude]] *(e.g., speed, mass)*, *vectors* describe **quantities where direction matters**, such as *velocity*, *force*, *displacement*, and *acceleration*.
- ###### Characteristics
	- Vectors **can be moved to different locations** as long as they *maintain their [[magnitude|magnitudes]] & directions*.
