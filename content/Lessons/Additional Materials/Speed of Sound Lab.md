...
The purpose of this experiment is to determine the speed of sound in air by means of resonance in a closed pipe. The wavelength of the sound wave is calculated by finding the particular lengths of an air column which give resonant standing waves for a given frequency of sound source. The speed of sound from the experiment is determined using the mathematical relationship between wavelength, frequency and wave speed established in this work. This experimental value is then directly compared to the accepted theoretical value of the speed of sound at standard room temperature.
...
The lengths of the pipe at which resonance occurs are given by the equation:

$$L_n = \frac{n\lambda}{4}$$

where $L_n$ is the resonant length of the air column, $n$ is an odd integer such as 1, 3, 5 or 7, and $\lambda$ is the total wavelength of the sound wave.


Resonance happens at every odd quarter wavelength . So the physical difference in length between any two resonant points in a row is exactly equal to half of the total wavelength . This relationship is expressed by:
...
Once the wavelength has been determined by physically measuring the pipe, the speed of sound can then be calculated using the wave equation:
$$v=f\lambda$$ where $v$ is the speed of sound in the air and $f$ is the particular frequency of the sound source used in the experiment. In air the theoretical speed of sound is very temperature dependent. The theoretical accepted speed of sound at 70°F (21.1°C) is approximately 344 m/s.
...
|---|---|---|
|First Resonance|23.2|0.232|
|Second Resonance|68.3|0.683|
